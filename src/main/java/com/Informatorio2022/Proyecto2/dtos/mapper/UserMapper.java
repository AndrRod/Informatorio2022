...
public class UserMapper {
    ...
    public User dtoPartToUserEntity(UserPartDto user){return new User(null, user.getFirstName(), user.getLastName(), user.getEmail(), user.getPassword(), Role.USER, null, false);};
